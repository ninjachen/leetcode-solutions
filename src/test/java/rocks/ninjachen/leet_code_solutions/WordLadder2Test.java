...
public class WordLadder2Test {
    ...
    public void testcase1() {
        ...
        Assert.assertEquals("[[\"hit\",\"hot\",\"dot\",\"dog\",\"cog\"], [\"hit\",\"hot\",\"lot\",\"log\",\"cog\"]]", ResourceUtil.print2dList(ans));
    }

    @Test
    public void testcase2() {
        List<List<String>> ans = solution.findLadders("a", "c", ResourceUtil.parseLineToStringList("[\"a\",\"b\",\"c\"]"));
        Assert.assertEquals("[[\"a\",\"c\"]]", ResourceUtil.print2dList(ans));
    }
    ...
    public void testcase3() {
        ...
        Assert.assertEquals("[[\"cat\",\"fat\",\"fit\",\"fin\"],[\"cat\",\"fat\",\"fan\",\"fin\"],[\"cat\",\"can\",\"fan\",\"fin\"]]", ResourceUtil.print2dList(ans));
    }
    ...
    public void testcase4() {
        ...
        Assert.assertEquals("[]", ResourceUtil.print2dList(ans));
    }
